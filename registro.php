    ...
    <div class="card-body register-card-body">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-6">
            <button style="margin: 0 0 20px 0;" type="submit" name="btnregister" class="btn btn-primary btn-block">Registrar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
                  ...
                  if(isset($_POST['btnregister'])){
                      ...
                      if(in_array($extensao, $formatP)){
                          ...
                          if(move_uploaded_file($temporario, $pasta.$novoNome)){
                            $cadastro = "INSERT INTO tb_registro (nome_registro, email_registro, senha_registro, foto_registro) VALUES (:nome, :email, :senha, :foto)";
